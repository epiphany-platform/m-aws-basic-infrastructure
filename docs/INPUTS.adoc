...
It is possible to use any available os image (virtual machine will be recreated after changing the values
) but Epiphany team supports and tests configuratuion on only the following:
